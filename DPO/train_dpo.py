        ...
        for epoch in range(cfg.num_epochs):
            for batch in dataloader:
                ...
                if (iter_idx + 1) % cfg.save_steps == 0:
                    model.save_pretrained(f"./ckpts/step_continue_{iter_idx + 1}")
                    tokenizer.save_pretrained(f"./ckpts/step_continue_{iter_idx + 1}")
...
if __name__ == "__main__":
    ...
    model.save_pretrained("./ckpts/dpo_last_continue")
    tokenizer.save_pretrained("./ckpts/dpo_last_continue")